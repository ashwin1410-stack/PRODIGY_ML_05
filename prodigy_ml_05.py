...
Original file is located at
    https://colab.research.google.com/drive/1JRclbpAVl4qUNFEIjvbuVyxzmLU-TTwC

# Food Calories Estimation Using Image Processing

**Introdcution**

*  Hello this is my task_05 for Prodigy Infotech Internship.
*  In this task we are going to do Food Calories Estimation using Image Processing with the help of DL Model
